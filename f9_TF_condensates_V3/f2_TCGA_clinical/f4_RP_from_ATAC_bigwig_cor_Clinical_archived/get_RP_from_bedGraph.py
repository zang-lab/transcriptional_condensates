...
def get_count_on_mapID(start,end,positions,scores,mid,expand):
    '''
...
def read_count_on_mapfile(afile,bdgfile,species,resolution,mid,expand):
    ...
    while line:
        ...
        if chrom in sorted_position_list:
            rp_score = get_count_on_mapID(start,end,sorted_position_list[chrom],sorted_score_list[chrom],mid,expand)
...
def main(afile,bdgfile,outfile,species,resolution,mid,expand):

    counting = read_count_on_mapfile(afile,bdgfile,species,resolution,mid,expand)
...
if __name__ == '__main__':
    ...
    main(args.afile,args.bdgfile,args.outfile,args.species,args.resolution,args.mid,args.expand)
