...
# == main 
indir = 'ATAC_overlap_TFBS_per_patient_sig_RP'
outdir = 'ATAC_overlap_TFBS_per_patient_sig_RP_combined'
        ...
        for factorType in ['top_TFBSCP','top_zscored_TFBSCP'][:]:
            ...
            for ii in np.arange(len(xticklabels))[:]:
                ...
                for patient in filtered_id[:]:
                    infile = '{}/{}/ATAC_overlap_{}_{}_{}_{}_RP.tsv'.format(indir,subdir,treat_flag,ct,xticklabels[ii],patient)
                ...
                out_df.to_csv('{}/{}/ATAC_overlap_{}_{}_{}_RP_combined.tsv'.format(outdir,subdir,treat_flag,ct,xticklabels[ii]))
