...
for indir in indirs[:]:
    ...
    df_out = df_out[(df_out['PeaksFCAbove10']>500)&(df_out['#TFMS']>2000)]
    ...
    for tf in sorted(tfs):
        for celltype in celltypes:
            ...
            data_index = [i for i in df_out.index if i.startswith('{}_{}_'.format(celltype,tf))]
