...
tfbs_dir = '../f2_cor_CP_SE_AICAP_V2_PeaksGT2k/f3_TFBS_CP_heatmap/_csv'   
...
for tfbs_cp_type in tfbs_cp_types[:1]:
    ...
    df = pd.read_csv('../f1_TFMS_TFBS_CP_V2_PeaksGT2k/{}/per_data_{}.csv'.format(tfbs_cp_type,tfbs_cp_type),index_col=0)
    # df = df[(df['#TFBS']>2000)]
