...
for tfbs_cp_type in tfbs_cp_types[:1]:
    ...
    for cp_type in cp_types[1:]:
        ...
        for factor in tfbs_cp_s.index[:]:
            ...
            df.to_csv(outdir+os.sep+'{}/_{}_{}.csv'.format(cp_type,tfbs_cp_type,factor))
            
            figname = outdir+os.sep+'{}/{}_{}.pdf'.format(cp_type,tfbs_cp_type,factor)
            scatter_plot(df,zlabel,ylabel,figname,factor)
