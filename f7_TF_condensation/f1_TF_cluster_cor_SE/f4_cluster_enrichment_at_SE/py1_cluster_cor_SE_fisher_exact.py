...
def main(se_basename):
    ...
    cluster_dir = '{}/f7_TF_condensation/f1_TF_cluster_cor_SE/f2_TF_fimo_jarspar_cluster/f5_motif_within_300bp'.format(project_dir)
    ...
    for cluster_file in cluster_files[:]:
        ...
        # == fisher exact test
        s,p = stats.fisher_exact([[cluster_overlap, cluster_total-cluster_overlap],
                                  [motif_overlap, motif_total-motif_overlap]])
