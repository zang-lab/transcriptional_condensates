...
def add_DNA_methylation_cov5(df,cancertype):
    cancer_type_matched = {'LUAD':'A549_cov5_vs_lung_cov5_WGBS','CRC':'HCT116_cov5_vs_sigmoid_colon_cov5','BRCA':'MCF7_cov5_vs_breast_cov5',\
                           'PRAD_TissueAdded':'LNCaP_cov5_vs_prostate_gland_cov5','T-ALL':'Jurkat_vs_A6010','PD9':'PD9_cov5_vs_A6010','PD30':'PD31_cov5_vs_A6010'}
    if cancertype in cancer_type_matched.keys():
        add_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f8_DNA_methylation/f2_union_binding_methylation_compr/f3_union_binding_differential_DNA_methylation_append/{}.csv'.format(cancer_type_matched[cancertype])
        with open(add_file) as add_inf:
