...
# ==== main  
indir1 = 'f1_ATAC_overlap_SE_caseID'
indir2 = 'f2_caseID_each_SE_vs_clinical'
outdir = 'f3_clinical_hicor_atac_regions'
...
for cancertype in ['BRCA','COAD'][:]:
    ...
    clinical_df = clinical_df[clinical_df['log rank p']<0.2]
