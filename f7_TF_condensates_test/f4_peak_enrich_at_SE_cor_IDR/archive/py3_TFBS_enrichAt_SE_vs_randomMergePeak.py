...
outdir = 'f3_TFBS_enrich_at_SE_vs_sampleMergePeak'
...
merge_file = '../f3_CellType_specific_peak_cor_SE/f3_union_peaks_across_cellTypes/{}.merge.bed'.format(factor)
...
for ii in np.arange(20):
    ...
    commandline = 'bedtools sample -i {} -n {} > {}'.format(merge_file,all_num,shuffle_file)
