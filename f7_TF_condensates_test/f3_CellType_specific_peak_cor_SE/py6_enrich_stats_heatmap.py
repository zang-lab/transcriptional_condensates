...
gs = gridspec.GridSpec(3,4,width_ratios=width_ratios,wspace=.2,hspace=.5)
...
plt.savefig('{}/log2_odds_ratio_heatmap.pdf'.format(outdir),bbox_inches='tight',pad_inches=0.02,transparent=True)
plt.show()
plt.close()
